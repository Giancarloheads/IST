        ...
        <div class="col-lg-10 col-12">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="ist-par-about-1 p-t-60 p-b-60">
                        The International School of Tianjin (formerly TEDA International School, Tianjin) opened the doors of a converted downtown Tianjin villa to some 20 children in Grades 1 to 4 on 5 September 1994. In 2001 IST relocated to purpose built facilities on a 7.2-hectare campus in Weishan Nan Lu in the city’s southeast. Student enrollment currently averages between 400 and 500 students.
                    </div>
                </div>
            </div>
        </div>
...
<div class="pin-section bg-grey p-b-60">
<section class="container-fluid slider-history-section p-t-60 p-b-60">
    <div class="row justify-content-center-md">
        <div class="col-10">
            <div class="row">
                <div class="col-10 text-left ist-about-title">
                    SCHOOL HISTORY
                </div>
            </div>
        </div>
...
<div class="section-slider-datas">
    <div class="years-container">
        <div class="history-slide-active" data-slider="0">
            1994
        </div>
        <div data-slider="1">
            1998
...
<section class="container-fluid p-t-md-60">
    <div class="row justify-content-center">
        <div class="col-lg-10 col-12">
            <div class="row">
                <div class="col-12">
                    <div class="history-slider-container">
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=1994" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=1998" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2001" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2002" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2004-2005" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2005" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2014" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2016-2017" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2018-2019" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2020" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="history-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12 offset-lg-2 offset-0 m-b-sm-60 order-1 order-lg-2">
                                    <img class="w-100" src="https://via.placeholder.com/1100x650/?text=2021" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
