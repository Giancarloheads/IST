            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="ist-caption-2">
                        IST holds a special place in the memories of graduates, past students, and former staff and faculty members. Learn about how you can stay in touch with our school and with the other community members who like you have contributed to the unique tapestry of our school. 
                    </div>
                </div>
            </div>
        </div>
...
<section class="container-fluid">
    <div class="row g-0">
        <div class="col-12">
            <img class="w-100 lazy" src="<?= get_template_directory_uri() . '/resources/img/alumni_topimg.jpg'; ?>" alt="">
        </div>
    </div>
</section>
            ...
            <div class="row gx-4 p-b-60">
                ...
                <div class="col-lg-6 col-12">
                    <div class="ist-caption-1">
                        ...
                        <p class="p-t-30">
                            We also encourage you to visit and LIKE the <a href="https://www.facebook.com" style="color:#CC0001;text-decoration:underline;">IST Alumni Facebook Page</a> to keep in constant touch with updates from the your IST family in Tianjin.
                        </p>
                    </div>
                </div>
            </div>
...
<section class="container-fluid p-t-120 p-b-120">
    <div class="row justify-content-center">
        <div class="col-lg-10 col-12">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h1 style="color:#000!important;" class="text-center">WE WOULD LOVE TO HEAR FROM YOU</h1>
                </div>
                <div class="col-lg-6 col-10 d-flex align-items-center justify-content-center p-t-60">
                    <a href="<?= get_permalink(217) ?>" class="cta-red" style="color: #fff;">SEND US AN E-MAIL<img onload="SVGInject(this);" src="<?= get_template_directory_uri()  . '/resources/icons/arrow.svg'; ?>" alt=""> </a>
                </div>
            </div>
        </div>
    </div>
